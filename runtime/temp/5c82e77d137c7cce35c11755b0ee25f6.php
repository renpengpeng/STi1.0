<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\phpstudy1\WWW\blog\template\admin\page\pageadmin.html";i:1512048568;s:34:"../template/admin/common/head.html";i:1512288094;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<div class="container">
			...
			<ul class="list-group">
				...
				<li class="list-group-item">
					<?php echo $pages['title']; ?>
					 ...
					 <span class="badge">
					 	<a href="<?php echo url('admin/page/Pageedit',['pageId'=>$pages['id']]); ?>">编辑</a>
					 </span>
				</li>
	...
	<div class="cate_administer_tianjia">
		<form action="<?php echo url('admin/common/newmessage',['type'=>'page']); ?>" method="post">
			<!-- 分类标题 -->
