<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:53:"D:\phpstudy1\WWW\blog\template\index\posts\index.html";i:1512221940;s:34:"../template/index/common/head.html";i:1512568770;s:37:"../template/index/common/sidebar.html";i:1511873995;s:36:"../template/index/common/footer.html";i:1512569067;}*/ ?>
 <!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="container">
  <!-- 文章展示部分 -->
  <div class=" col-md-9">
  <div class="single" style="border: 1px solid #eee;">
    <div class="single_title">
      <?php echo $postArr['title']; ?>
    </div>
    <div class="single_info">
      作者：<?php echo $postArr['userName']; ?>&nbsp;&nbsp;
      分类：<?php echo $postArr['cateName']; ?>&nbsp;&nbsp;
      发布时间：<?php echo $postArr['time']; ?>&nbsp;&nbsp;
      阅读量：<?php echo $postArr['views']; ?>&nbsp;&nbsp;
    </div>
    <div class="single_content">
      <?php echo $postArr['content']; ?>
    </div>
     <!-- 开始标签 -->
    <div class="single_tags">
       标签：
    <?php if((!$postArr['tags']) OR (!isset($postArr['tags']))): ?>
    暂无标签
    <?php else: if(is_array($postArr['tags']) || $postArr['tags'] instanceof \think\Collection || $postArr['tags'] instanceof \think\Paginator): $i = 0; $__LIST__ = $postArr['tags'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tags): $mod = ($i % 2 );++$i;?>
      <a href="<?php echo url('index/tags/index',['tagId'=>$tags['id']]); ?>"><?php echo $tags['name']; ?></a>
