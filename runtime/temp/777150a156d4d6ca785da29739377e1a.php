<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\phpstudy1\WWW\blog\template\admin\post\postedit.html";i:1512038995;s:34:"../template/admin/common/head.html";i:1512033721;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<div class="content">
		...
		<div class="content_content">
			<div class="post_edit_form">
				...
				<form action="<?php echo url('admin/common/updateMessage',[
					'type'=>'post'
				]); ?>" method="post">
				<!-- 隐藏域文章id -->
...
<script type="text/javascript">
	...
	ue.ready(function() {
    //设置编辑器的内容
    ue.setContent('<?php echo $postArr['content']; ?>');
